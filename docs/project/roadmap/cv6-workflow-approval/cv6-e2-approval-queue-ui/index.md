...
| Code | Story | Status |
|------|-------|--------|
| CV6.E2.S1 | "My queue" page filtered by current actor | ✅ Done |
| CV6.E2.S2 | Approval card with evidence strip + before/after impact summary | ✅ Done |
| CV6.E2.S3 | `ApprovalStep` visualization showing path progress | ✅ Done |
| CV6.E2.S4 | Approve / Request Changes / Reject actions with structured reasons | ✅ Done |
| CV6.E2.S5 | Tabs: My queue · Semi-automated · Completed · Overrides | ✅ Done |
| CV6.E2.S6 | Automation policy table view (read-only at MVP) | ✅ Done |
