...
| [CV6.E3](cv6-e3-audit-trail/index.md) | Audit Trail | Append-only `audit.events` topic + queryable view; every recommendation, approval, override, and source-write is logged | ✅ Done |
| [CV6.E4](cv6-e4-source-system-write-dispatch/index.md) | Source-System Write Dispatch | Approved actions dispatched behind a `SourceWriter` seam with idempotency, retries, dead-letter, and delivery receipts (live Maximo write client deferred to CV2.E1.S10) | 🟢 In Progress |
