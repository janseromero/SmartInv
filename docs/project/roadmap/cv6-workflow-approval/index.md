...
| [CV6.E3](cv6-e3-audit-trail/index.md) | Audit Trail | Append-only `audit.events` topic + queryable view; every recommendation, approval, override, and source-write is logged | 🟢 In Progress |
